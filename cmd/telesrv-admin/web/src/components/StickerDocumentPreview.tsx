...
// One preview cell for a sticker/emoji document. TGS documents are exposed by
// the BFF as decompressed Lottie JSON; static stickers come back as image bytes.
export function StickerDocumentPreview({
  documentID,
  className = "",
  showError = true
}: {
